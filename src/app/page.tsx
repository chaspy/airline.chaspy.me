...
const routes = [
  ...
  { from: 'NRT', to: 'NGO', airline: 'ANA' },
  { from: 'NRT', to: 'CTS', airline: 'ANA' },
  { from: 'HND', to: '福江', airline: 'ANA' },
  { from: 'HND', to: '松山', airline: 'ANA' },
  { from: 'CTS', to: '静岡', airline: 'ANA' },
  { from: 'FUK', to: '宮崎', airline: 'ANA' },
  { from: 'OKA', to: '仙台', airline: 'ANA' },
  { from: 'OKA', to: '松山', airline: 'ANA' },
  { from: 'ISG', to: '宮古', airline: 'ANA' },
